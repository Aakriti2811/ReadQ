...
function About() {
  return (
    <>
    <Navbar/>
    <div className="w-[100%] h-screen flex flex-col items-center align-middle mx-auto px-6 py-36 ">
      <h1 className="text-4xl font-bold text-center text-pink-600">About ReadQ 📚</h1>
      <p className="text-lg  text-center w-[80%] mt-4">
      ...
      <div className="text-center mt-10">
        <h2 className="text-xl font-semibold"> Start your reading journey with ReadQ today!</h2>
      </div>
    </div>
    <Footer/>
    </>
